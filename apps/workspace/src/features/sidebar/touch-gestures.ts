...
/**
 * Advances a touch on a tree row. A horizontal pull becomes a swipe that drags
 * the row toward deletion; a vertical pull is the list scrolling and cancels
 * everything, including the pending long press; anything smaller keeps the
 * long press armed.
 */
