 ...
 */
export function VoiceDictationHost({ store, signal, getView, getNoteId }: VoiceDictationHostProps) {
...
type BodyProps = VoiceDictationHostProps & { noteId: string };
