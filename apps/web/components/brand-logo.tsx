        ...
        const interval = setInterval(() => {
            setParticles(prev => {
                ...
                if (Math.random() > 0.7 && newParticles.length < 20) {
                    const spawnPoints = variant === 'sidebar'
                        ? [
                            { x: 8, y: 20 },
                            { x: 20, y: 20 },
                            { x: 32, y: 20 }
        ...
        <div className="relative inline-block">
            ...
            >
                ...
                <g fill="url(#logoGradient)" filter="url(#glow)">
                    {isSidebar ? (
                        <>
                            <Rect x="4" y="8" width="8" height="24" rx="1" custom={0} variants={pathVariants} />
                            <Rect x="16" y="4" width="8" height="32" rx="1" custom={1} variants={pathVariants} />
                            <Rect x="28" y="12" width="8" height="16" rx="1" custom={2} variants={pathVariants} />
                        </>
                    ) : (
                        <>
                            <Path
