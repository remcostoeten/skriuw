        ...
        >
            <g fill="currentColor">
                {isSidebar ? (
                    <>
                        {/* First bar - leftmost */}
                        <Rect x="4" y="8" width="8" height="24" rx="1" variants={pathVariants} />
                        {/* Second bar - middle */}
                        <Rect x="16" y="4" width="8" height="32" rx="1" variants={pathVariants} />
                        {/* Third bar - rightmost */}
                        <Rect x="28" y="12" width="8" height="16" rx="1" variants={pathVariants} />
                    </>
                ) : (
                    <>
                        {/* Left Shape */}
