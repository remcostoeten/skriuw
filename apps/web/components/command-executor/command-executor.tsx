...
function filterCommands(
	commands: Array<{ id: ShortcutId; description: string; keys: string }>,
	query: string
) {
									...
									{group.commands.map((command) => {
										...
										return (
											<button
												...
												className={`w-full flex items-center justify-between rounded-md px-2 py-2 text-sm transition-colors ${
													isSelected
