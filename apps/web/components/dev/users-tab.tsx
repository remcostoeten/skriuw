...
export function UsersTab({ stats }: { stats?: DbStats | null }) {
    ...
    const resetUser = useCallback(
        async (userId: string) => {
            if (!confirm('Reset this user? All their notes, folders, tasks, and settings will be deleted.'))
                return
    ...
    const deleteUser = useCallback(
        async (userId: string) => {
            if (!confirm('Delete this user entirely? This action cannot be undone.'))
                return
