			...
			<div className="grid md:grid-cols-2 gap-6">
				<Card className="p-6 space-y-4">
					...
					<div className="space-y-3">
						...
						<Button
							...
							onClick={() => {
								notify(
									'This notification will stay for a while'
								).duration(5000)
				...
				<Card className="p-6 space-y-4">
					...
					<div className="space-y-3">
						<Button
							onClick={() => {
								notify('Item deleted').allowRevert(
									'Undo',
									() => {
						...
						<Button
							...
							onClick={() => {
								let count = 0
								notify('Action completed').allowRevert(
									'Redo',
									() => {
										count++
										addLog(
											`Action repeated (count: ${count})`
										)
				...
				<Card className="p-6 space-y-4">
					...
					<div className="space-y-3">
						<Button
							...
							onClick={() => {
								notify('✓ Changes saved successfully').duration(
									3000
								)
