			...
			<div className="flex-1 flex flex-col overflow-hidden">
				...
				>
					...
					<motion.div 
						...
						dragElastic={{ left: canGoRight ? 0.15 : 0.05, right: canGoLeft ? 0.15 : 0.05 }}
											...
											<CardHeader className="pb-3 md:pb-6 px-4 md:px-6">
												...
												>
													...
													<CardDescription className="text-xs md:text-sm">
														Create a backup of all your notes and folders
													</CardDescription>
												</motion.div>
											</CardHeader>
												...
												>
													<div className="rounded-lg border border-border/60 bg-muted/40 p-3 text-xs md:text-sm text-muted-foreground space-y-2">
														<p className="flex items-start gap-2">
															<span className="font-semibold text-foreground shrink-0">JSON:</span>
															<span>Complete backup with formatting</span>
														</p>
														<p className="flex items-start gap-2">
															<span className="font-semibold text-foreground shrink-0">Markdown:</span>
										...
										<Card key="import" className="border-border/70 shadow-sm w-full overflow-hidden">
											<CardHeader className="pb-3 md:pb-6 px-4 md:px-6">
												...
												>
													...
													<CardDescription className="text-xs md:text-sm">
														Restore from backup or import from other apps
													</CardDescription>
												</motion.div>
											</CardHeader>
											<CardContent className="px-4 md:px-6 pb-6">
												...
												>
													<div className="rounded-lg border border-border/60 bg-muted/40 p-3 text-xs md:text-sm text-muted-foreground space-y-2">
														...
														<p className="text-[10px] md:text-xs text-muted-foreground/70 pt-1 border-t border-border/40">
															Non-destructive: won't overwrite existing notes
														</p>
													</div>
													<ImportPanel />
												</motion.div>
