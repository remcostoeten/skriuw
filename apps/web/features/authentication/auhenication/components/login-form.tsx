...
export function LoginForm({
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        console.log(isRegisterMode ? "Register" : "Login", { email, password });
    };
        ...
        <div className="w-full max-w-md space-y-8 relative">
            ...
            {onToggleTheme && (
                <button
                    ...
                    className="absolute -top-12 right-0 p-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors"
