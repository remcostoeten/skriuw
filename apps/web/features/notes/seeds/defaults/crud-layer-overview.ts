...
export const crudLayerOverviewSeed = {
	name: 'CRUD Layer Overview',
	parentFolderName: 'Development Docs',
	contentMarkdown: `# CRUD Layer Architecture
...
registerGenericStorageAdapter('localStorage', (config) => {
  return {
    create: (key, data) => { /* localStorage logic */ },
    read: (key, options) => { /* localStorage logic */ },
    // ... other methods
  }
})
\`\`\`
