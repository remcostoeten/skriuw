...
import { Check, ChevronDown, ChevronUp, Code2, Copy, Maximize2, Minimize2 } from 'lucide-react'
					...
					<div className="flex items-center justify-between px-3 py-1.5 border-b border-border/50 bg-muted/30 select-none">
						...
						<div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
							<input
								...
								className="w-16 text-xs text-muted-foreground bg-transparent border border-border/30 rounded px-1 py-0.5 focus:outline-none focus:border-border/60"
								title="Max height (px)"
								min="100"
								max="1000"
							/>
