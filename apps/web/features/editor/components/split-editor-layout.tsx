...
import { Columns, StretchHorizontal, StretchVertical, ArrowLeftRight, X } from 'lucide-react'
...
export function SplitEditorLayout({
    ...
    const renderPaneControls = (pane: SplitPane, isPrimary: boolean) => (
        <div className="absolute right-2 top-2 z-10 flex items-center gap-1 text-muted-foreground">
    ...
    const renderPaneContainer = (pane: SplitPane, isPrimary: boolean) => (
        <div
            key={pane.id}
            className={cn(
                'relative flex-1 overflow-hidden rounded-md border border-border bg-background-secondary',
                    ...
                    <div
                        className={cn(
                            ...
                            orientation === 'vertical'
                                ...
                                : '-top-1.5 bottom-0 left-0 right-0',
