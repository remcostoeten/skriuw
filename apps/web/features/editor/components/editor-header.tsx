                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-6 px-2 -ml-2 text-xs text-muted-foreground hover:text-foreground"
                                >
                            ...
                            <PopoverContent className="w-48 p-1" align="start">
                                <label className="flex items-center gap-2 px-2 py-1.5 text-sm rounded-sm hover:bg-accent cursor-pointer">
                                ...
                                <button
                                    type="button"
                                    className="flex items-center gap-2 px-2 py-1.5 text-sm rounded-sm hover:bg-accent w-full text-left"
                                    onClick={() => {
                                        const url =
                        ...
                        <div className="flex items-center gap-2">
                            <CollapsibleTrigger asChild>
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="-ml-3 h-6 text-muted-foreground hover:text-foreground"
                                >
                                    {isInfoOpen ? (
                                        ...
                                        {tags.length > 0 ? (
                                            tags.map(tag => (
                                                <Badge
                                                    key={tag}
                                                    variant="secondary"
                                                    className="bg-muted text-muted-foreground hover:bg-muted/80 rounded-sm font-normal text-xs px-1.5 flex items-center gap-1"
                                                >
                                                    {tag}
                                                    {setTags && (
                                                        <button
