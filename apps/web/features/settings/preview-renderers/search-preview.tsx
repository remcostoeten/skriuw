    ...
    return (
        <div className="mt-3 rounded-md overflow-hidden border border-border bg-background-secondary">
            ...
            <div className="p-2 space-y-1">
                <div className="flex items-center gap-2 p-2 rounded-md hover:bg-muted/50">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="text-sm font-medium text-foreground">
                            <span className="bg-yellow-500/20 text-yellow-500">Project</span> Plan.md
                        </div>
                ...
                <div className={`flex items-center gap-2 p-2 rounded-md transition-opacity duration-200 ${value ? 'opacity-100' : 'opacity-30 grayscale'}`}>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-muted-foreground truncate">
                            ...discuss the <span className={value ? "bg-yellow-500/20 text-yellow-500" : ""}>project</span> timeline...
                        </div>
                    </div>
                    {!value && (
