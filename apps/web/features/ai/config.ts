...
function getSetting(key: string): string | undefined {
	...
	console.log('Getting setting for:', key) // Prevent unused variable warning
	return undefined
}
...
export function getGlobalProvider(): Provider {
	...
	const geminiKey =
		(typeof process !== 'undefined' && process.env?.GEMINI_KEY) ||
		(typeof process !== 'undefined' && process.env?.GEMINI_BACKUP_KEY) ||
		(typeof process !== 'undefined' && process.env?.GEMINI_THIRD_BACKUP_KEY)
