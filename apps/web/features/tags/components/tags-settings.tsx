...
import { useTagsWithCountQuery, useUpdateTagMutation, useDeleteTagMutation, useCreateTagMutation } from "../hooks/use-tags-query"
            ...
            {showNew && (
                <div className="flex items-center gap-3 py-3 border-b border-border/50">
                    ...
                    <div className="flex items-center gap-1">
                        <Button size="sm" variant="ghost" onClick={() => setShowNew(false)} className="h-8 w-8 p-0">
                            <X className="w-4 h-4" />
                        </Button>
                            ...
                            {editingId === tag.id ? (
                                <div className="flex items-center gap-3 flex-1">
                                        ...
                                        {TAG_COLORS.map(color => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    editColor === color && "ring-2 ring-offset-1 ring-offset-background ring-primary scale-110"
                                                )}
                                                style={{ backgroundColor: color }}
                                            />
                                        ))}
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <Button size="sm" onClick={saveEdit} disabled={!editName.trim()} className="h-7 w-7 p-0">
                                ...
                                <>
                                    <div className="flex items-center gap-3">
                                        <TagBadge name={tag.name} color={tag.color ?? '#6366f1'} size="md" />
