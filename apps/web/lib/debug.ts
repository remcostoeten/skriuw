...
const styles: Record<string, string> = {
    ...
    shortcuts: 'background: #8710be; color: white; padding: 2px 6px; border-radius: 3px; font-weight: bold;',
    network: 'background: #00875a; color: white; padding: 2px 6px; border-radius: 3px; font-weight: bold;',
    ...
    general: 'background: #2b303b; color: white; padding: 2px 6px; border-radius: 3px; font-weight: bold;',
}
...
export function getDebugConfig() {
    return {
        ...
        isDebugActive: activeFlags.size > 0 ||
            checkLegacyEnv('auth') ||
