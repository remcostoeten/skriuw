...
---`,
		...
		// Intro
		paragraph('Success. Secure uplink established. Welcome to your personal command center.', {
			bold: true
		}),
		paragraph(
			'This interface is a live reflection of your digital environment, rendered directly from the neural core of the Skriuw editor.'
		),
		...
		// Feature list
		{
			...
			content: [
				{
					type: 'text' as const,
					text: 'Slash Commands (/ to activate)',
					styles: { code: true }
				}
			],
			children: []
		},
		{
			...
			content: [
				{ type: 'text' as const, text: 'Markdown Shortcuts (try # or **)', styles: {} }
			],
			children: []
		},
		{
