...
const styles = {
    ...
    shortcuts: 'background: #8710be; color: white; padding: 2px 4px; border-radius: 2px; font-weight: bold;',
    general: 'background: #2b303b; color: white; padding: 2px 4px; border-radius: 2px; font-weight: bold;',
}
...
class Logger {
    ...
    private formatMessage(category: LogCategory, message: string): string[] {
        return [`%c${icons[category]} [${category.toUpperCase()}]`, styles[category], message]
    }
