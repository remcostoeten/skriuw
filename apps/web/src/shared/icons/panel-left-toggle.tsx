...
/**
 * Mirror of PanelRightToggleIcon: divider sits on the left half of the
 * container and the hover glide runs in the opposite (leftward) direction.
 */
const PanelLeftToggleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
