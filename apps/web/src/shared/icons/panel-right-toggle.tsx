...
const PanelRightToggleIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
		...
		return (
			<LazyMotion features={domAnimation} strict>
				...
				>
					...
					<m.path className="panel-divider" d="M15 4l0 16" />
				</m.svg>
			</LazyMotion>
		);
	},
...
PanelRightToggleIcon.displayName = "PanelRightToggleIcon";
export { PanelRightToggleIcon };
