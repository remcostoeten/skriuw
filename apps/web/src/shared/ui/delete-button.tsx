    ...
    <div className="flex items-center gap-2">
      <button
        ...
        className={cn(
          ...
          !disabled && danger && "border-destructive/60 bg-destructive/15 text-destructive-foreground",
          !disabled && !danger && !solid && "border-input bg-secondary text-secondary-foreground hover:bg-accent",
