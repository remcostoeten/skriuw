	...
	return (
		<div className="relative">
			...
			<p id={hintId} className="sr-only">
				Type @ to open email domain suggestions. Arrow keys move through options, Enter
				accepts the selected option, and Tab accepts the first suggestion.
			</p>
			...
			{isOpen ? (
				<div className="absolute left-0 right-0 top-[calc(100%+0.5rem)] z-50 overflow-hidden border border-border bg-card shadow-[0_24px_60px_hsl(var(--scrim)_/_0.42)]">
					...
					{suggestions.length > 0 ? (
						...
						<div className="px-3 py-3 text-sm text-muted-foreground">
							No matching domains yet. Keep typing or try a common provider like Gmail
							or Proton.
						</div>
					)}
				</div>
