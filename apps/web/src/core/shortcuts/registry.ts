...
export const SHORTCUT_REGISTRY = {
	...
	"drawing.selection": {
		keys: "v",
		scope: SCOPES.drawing,
		group: "Drawing",
		label: "Selection tool",
		description: "Select, move, and resize drawing elements.",
		preventDefault: true,
	},
	"drawing.rectangle": {
		keys: "r",
	...
	"notes.cycleTabForward": {
		keys: "shift+tab",
		scope: SCOPES.notes,
		group: "Notes",
		label: "Cycle to next tab",
		description: "Move to the next open tab in the focused pane, wrapping around.",
		except: "typing",
		preventDefault: true,
	},
	"notes.cycleTabBackward": {
		keys: "ctrl+shift+tab",
		scope: SCOPES.notes,
		group: "Notes",
		label: "Cycle to previous tab",
		description: "Move to the previous open tab in the focused pane, wrapping around.",
		except: "typing",
		preventDefault: true,
	},
	"notes.focusEditor": {
