...
The Seeder Tool requires your Skriuw App ID to be configured:
...
**Finding Your App ID:**
1. Log in to [Skriuw Dashboard](https://instantdb.com)
2. Select your app
3. Copy the App ID from the settings page

### 2. Database Schema

Ensure your Skriuw schema includes:
...
The seeder uses the schema from `apps/web/src/api/db/schema.ts`.
