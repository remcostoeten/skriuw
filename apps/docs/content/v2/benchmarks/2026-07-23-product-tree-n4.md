---
title: "Product tree N4 integration measurement"
---
...
node app/performance/run.mjs \
  --output tools/benchmarks/raw/2026-07-23-product-tree-n4.json
```
...
`tools/benchmarks/raw/2026-07-23-product-tree-n4.json`.
