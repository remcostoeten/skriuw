---
title: "Mobile release readiness: performance evidence, 2026-09-20"
description: "Evidence for the mobile client against Performance contract and the performance requirements in Mobile app (R-P1 to R-P4), taken at the point where Mobile 01 to Mobile 15 are on daddy."
---
...
- Harness and reproduction commands:
  [`harness/README.md`](https://github.com/remcostoeten/skriuw/blob/daddy/tools/benchmarks/harness/README.md). Raw samples in
  [`raw/2026-09-20-mobile-scale-1000.json`](https://github.com/remcostoeten/skriuw/blob/daddy/tools/benchmarks/raw/2026-09-20-mobile-scale-1000.json),
  [`raw/2026-09-20-mobile-scale-5000.json`](https://github.com/remcostoeten/skriuw/blob/daddy/tools/benchmarks/raw/2026-09-20-mobile-scale-5000.json),
