---
title: "Reference production performance gate"
---
...
node app/performance/run.mjs \
  --output tools/benchmarks/raw/2026-07-24-reference-production-raw.json
```
...
`tools/benchmarks/raw/2026-07-24-reference-production-raw.json`.
