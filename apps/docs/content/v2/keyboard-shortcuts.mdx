...
| Shortcut | Action | Notes |
| --- | --- | --- |
| `mod+alt+p` | Toggle diagram source | Flips the Mermaid code block under the caret between its rendered preview and its source. Enter on a selected preview opens the source; Escape returns to the preview. |
