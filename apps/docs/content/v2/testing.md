...
description: "This covers the v2 TypeScript suites for apps/, packages/, and services/. Rust tests run through cargo test inside bin/check. The frozen v1 tree still uses bun:test and is out of scope."
---
