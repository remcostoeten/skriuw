---
title: "ADR-0027: Browser SQLite uses a worker-owned OPFS SAH pool"
---
...
- The build pins the matching `wasm-bindgen` CLI, emits the ignored WASM module
  ...
  [Browser runtime scale and cross-browser durability: 2026-08-05](/v2/benchmarks/2026-08-05-browser-runtime-scale). Safari evidence and
