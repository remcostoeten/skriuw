---
title: "0036 — AI text results are reviewed in place, not in a modal"
---

## Status

Accepted, 2026-08-28. Extended by
[ADR-0040](/v2/adr/0040-ai-runs-are-visible-work), which applies the same rule to the
...
[ADR-0040](/v2/adr/0040-ai-runs-are-visible-work) reversed that: they render in the
