---
title: "ADR-0020: UI architecture selection"
---
...
complete, with evidence recorded under [Benchmarks](/v2/benchmarks):
...
[Performance contract](/v2/performance-contract) in its spike: cached editor swap, tree interaction,
