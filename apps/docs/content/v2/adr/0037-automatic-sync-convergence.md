---
title: "ADR-0037: Automatic sync convergence"
---
...
[sync convergence v1](/v2/specs/sync-convergence-v1) filled that gap with a
...
- Portable export no longer fails closed on sync state. Sections 3 and 4 of
  [sync convergence v1](/v2/specs/sync-convergence-v1) as written before
  ...
  [ADR-0035](/v2/adr/0035-note-annotation-layer) (annotation edits resolve as a
