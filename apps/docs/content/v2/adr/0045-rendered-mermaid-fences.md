---
title: "ADR-0045: Rendered Mermaid fences"
---
...
The editable diagram block ([spec](/v2/specs/embedded-diagrams)) covers one
...
and typing budgets in the [performance contract](/v2/performance-contract)
...
Measurements are in
[the render benchmark](/v2/benchmarks/2026-09-17-mermaid-render).
