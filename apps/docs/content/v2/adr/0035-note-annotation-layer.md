---
title: "ADR-0035: The note annotation layer is versioned document data"
---
...
far larger than the feature, and [Performance contract](/v2/performance-contract) forbids
...
- A concurrent two-device annotation edit is an ordinary `SaveDocument`
  ...
  [ADR-0037](/v2/adr/0037-automatic-sync-convergence); the losing body is
