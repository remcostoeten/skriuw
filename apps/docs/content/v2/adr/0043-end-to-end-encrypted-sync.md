---
title: "ADR-0043: End-to-end encrypted sync"
---
...
[ADR-0026](/v2/adr/0026-optional-cloud-operation-replication) replicates versioned
...
content-addressed chunks ([sync content chunks v1](/v2/specs/sync-content-chunks-v1)).
...
[ADR-0037](/v2/adr/0037-automatic-sync-convergence) moved convergence entirely
...
[Cloud sync master tracker](/v2/specs/cloud-sync-master) carried this as an open decision before
...
- The Worker is still deployed before the clients that need it, and that order
  ...
  `daddy` through Vercel, so [Cloud and web delivery plan](/v2/specs/cloud-sync-delivery) makes the
