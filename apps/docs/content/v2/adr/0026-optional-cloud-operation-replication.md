---
title: "ADR-0026: Optional cloud operation replication"
---
...
[workspace operation sync policy](/v2/specs/workspace-operation-sync-policy-v1).
...
[local sync outbox contract](/v2/specs/local-sync-outbox): replicated local
