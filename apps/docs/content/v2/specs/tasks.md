...
Proposed implementation specification, 2026-08-15. Extends [Checklist task promotion](/v2/specs/task-promotion)
and implements the renderer half of [0031 — Explicit task promotion](/v2/adr/0031-explicit-task-promotion).
...
[Performance contract](/v2/performance-contract). The binding invariants for this work:
...
Bound by [Performance contract](/v2/performance-contract).
...
2,000-block fixture and record it under [Benchmarks](/v2/benchmarks).
...
| [0032 — Task-shaped typing is explicit intent](/v2/adr/0032-task-shaped-typing-is-explicit) *(new)* | Amend ADR 0031's "nothing promotes implicitly" for the typing gesture | Durable reasoning. |
| [Features](/v2/features) | Document the checkbox/task distinction | User-facing feature list. |
...
1. Read [0031 — Explicit task promotion](/v2/adr/0031-explicit-task-promotion) and
   [Checklist task promotion](/v2/specs/task-promotion). They are short and they are binding.
...
8. Write ADR 0032 and update [Features](/v2/features).
9. Run `./bin/check`.
...
- [ ] Write [0032 — Task-shaped typing is explicit intent](/v2/adr/0032-task-shaped-typing-is-explicit) amending ADR
...
- [ ] Update [Features](/v2/features) with the checkbox-versus-task distinction.
- [ ] Add a cross-reference from [Checklist task promotion](/v2/specs/task-promotion) to this file.
...
13. No new table, migration, node type, schema attribute, or generated contract
    is introduced.
14. Keystroke-to-paint stays within [Performance contract](/v2/performance-contract); no IPC,
