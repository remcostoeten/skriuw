---
title: "Find in note (Ctrl+F / find-and-replace)"
description: "A self-contained guide to replicating Skriuw's in-editor find-and-replace: a VS Code-style search widget over a ProseMirror document, with match highlighting, next/previous navigation, match case / whole word / regex options, and replace / replace-all."
---
