---
title: "Cloud and web delivery plan"
---

Status: implementation plan.
Canonical scope and completion status: [cloud sync master tracker](/v2/specs/cloud-sync-master).
...
master tracker, [ADR-0026](/v2/adr/0026-optional-cloud-operation-replication),
or the [performance contract](/v2/performance-contract).
...
produces a user-facing conflict ([ADR-0037](/v2/adr/0037-automatic-sync-convergence)).
