...
Mermaid families ([ADR-0045](/v2/adr/0045-rendered-mermaid-fences)).
...
[the diagram benchmark note](/v2/benchmarks/2026-08-02-diagram-routing).
...
the AI **Diagram** action ([AI editor actions](/v2/specs/ai-editor-actions#diagram-results)),
...
- Rendered fences: family detection, palette conversion, sanitizing, memo
  ...
  timings live in [the render benchmark](/v2/benchmarks/2026-09-17-mermaid-render).
