...
description: "The implementation contract for the selection and whole-note AI actions that put model output next to canonical documents. It sits under ADR-0033 and reconciles the v1-parity AI actions plan against the code that actually shipped in the AI platform milestone."
---
...
typed one ([embedded diagrams](/v2/specs/embedded-diagrams#rendered-mermaid-fences)),
...
[AI run history and token usage](/v2/specs/ai-run-history).
