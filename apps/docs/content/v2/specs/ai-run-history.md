---
title: "AI run history and token usage"
description: "The product contract ADR-0033 requires before locally persisting per-request AI metadata. It covers what is recorded, where, for how long, and how it is erased."
---
...
`0018_ai_run_history`). The table is diagnostics-class local state: no
