...
[Bounded workspace intake](/v2/specs/bounded-workspace-intake).
...
- [ADR 0034 — Annotation anchors are document data, conversations are not](/v2/adr/0034-annotation-anchors-are-document-data)
