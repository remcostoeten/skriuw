---
title: "Content-addressed chunk transport v1"
---
...
[content operations](/v2/specs/sync-content-operations) for running them.
...
[cloud sync authentication](/v2/specs/cloud-sync-authentication).
...
- The generated [content manifest schema](https://github.com/remcostoeten/skriuw/blob/daddy/contracts/generated/content-manifest.schema.json)
  is committed and drift-checked.
- [`sync-push-v1.json`](https://github.com/remcostoeten/skriuw/blob/daddy/contracts/fixtures/sync-push-v1.json) is retained
  as the legacy golden request that exercises the Worker upgrade shim.
  [`sync-push-v2.json`](https://github.com/remcostoeten/skriuw/blob/daddy/contracts/fixtures/sync-push-v2.json) is the
...
[coordinator contract](/v2/specs/desktop-sync-coordinator#checkpoints-rehydration-and-retention).
...
[desktop sync coordinator](/v2/specs/desktop-sync-coordinator) specification.
