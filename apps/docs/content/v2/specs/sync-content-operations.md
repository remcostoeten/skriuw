---
title: "Sync content, checkpoint, and retention operations"
---
...
[content-addressed chunk transport v1](/v2/specs/sync-content-chunks-v1); the trust
...
[the coordinator contract](/v2/specs/desktop-sync-coordinator#checkpoints-rehydration-and-retention).
...
database and are covered by [sync convergence v1](/v2/specs/sync-convergence-v1);
...
remains open on the [master tracker](/v2/specs/cloud-sync-master).
