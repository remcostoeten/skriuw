...
[ADR-0048](/v2/adr/0048-native-mobile-shell-over-shared-core). Work is tracked
...
[Performance contract](/v2/performance-contract) applies unchanged. In particular:
...
- **R-P4** Cold start to interactive tree: 1.5 s P95 on the reference Android
  device with the 1,000-note fixture. Recorded in [Benchmarks](/v2/benchmarks).
