---
title: "Local sync connection and transactional outbox"
---
...
[workspace operation sync policy](/v2/specs/workspace-operation-sync-policy-v1) and
the [sync coordinator](/v2/specs/desktop-sync-coordinator): the connection record,
...
[sync convergence v1](/v2/specs/sync-convergence-v1).
...
[sync convergence v1 §4](/v2/specs/sync-convergence-v1#4-document-decision-and-history-provenance).
