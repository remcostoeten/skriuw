---
title: "Tasks workspace view"
---

## Status

Implemented, 2026-08-15. Follow-up to [First-class tasks](/v2/specs/tasks), which delivered
...
1. [First-class tasks](/v2/specs/tasks) — the model this view renders. Especially "Stable
   identity and source navigation" and "Future Task projection / `/tasks`".
2. [0031 — Explicit task promotion](/v2/adr/0031-explicit-task-promotion) — binding. The "Consequences"
   section contains the rule that decides this entire feature.
3. [0032 — Task-shaped typing is explicit intent](/v2/adr/0032-task-shaped-typing-is-explicit).
4. [Performance contract](/v2/performance-contract).
...
| [Features](/v2/features) | Document the surface |
