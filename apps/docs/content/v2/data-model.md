...
Optional connected-mode operational state, all excluded from portable archives and retained by native backup. See the [local sync outbox contract](/v2/specs/local-sync-outbox).
