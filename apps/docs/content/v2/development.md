...
description: "Contributor-facing detail that goes beyond the quick start in the README."
---
...
[services/sync/README.md](https://github.com/remcostoeten/skriuw/blob/daddy/services/sync/README.md) for deployment. Development and release
...
[the deploy order](https://github.com/remcostoeten/skriuw/blob/daddy/services/sync/README.md#deploy-order). `GET /health` reports the
