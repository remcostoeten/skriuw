...
This page is the map; the detail pages are [Self-host with Docker](/v1/infra/self-host-docker)
and [Release pipeline](/v1/infra/release-pipeline).
...
- **Self-host (Docker)**, you want a server/homelab instance you own, usable
  ...
  [Self-host with Docker](/v1/infra/self-host-docker).
