 ...
 * `apps/workspace/src/features/lock/lock-model.ts`; the wording differs where a phone has
 ...
 * (`apps/workspace/src/features/settings/sections/sync-encryption.ts`). A lock recovery
