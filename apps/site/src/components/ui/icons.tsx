...
export function CalendarRange(props: Props) {
  return (
    <svg {...base(props)}>
...
export function XSocial(props: Props) {
  return (
...
export function GithubSocial(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function Windows(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function Linux(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function Android(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export function Pwa(props: Props) {
  return (
    <svg {...base(props)}>
