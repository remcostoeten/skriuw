...
Rust domain types are canonical during backend foundation work. `./bin/generate` exports transport schemas into `contracts/generated`.
...
`apps/workspace/src/contracts/ai.ts` and are checked by the renderer type gate.
...
[`__tests__/fixtures/contracts/sync-push-v1.json`](../__tests__/fixtures/contracts/sync-push-v1.json) is the first cross-language golden request. Inline
