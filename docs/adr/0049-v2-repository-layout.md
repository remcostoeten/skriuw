...
- The Homebrew cask lives in the `skriuw/homebrew-tap` repository and the Scoop manifest in `skriuw/scoop-bucket`; the root `tap_migrations.json` moves users of the old tap-by-URL there.
