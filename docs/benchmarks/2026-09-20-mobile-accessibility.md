# Mobile accessibility pass, 2026-09-20

The R-Q2 pass for the mobile client: *every screen is operable with VoiceOver
and TalkBack; touch targets are at least 44 pt* (`docs/specs/mobile-app.md`).
...
[the readiness document](2026-09-20-mobile-release-readiness.md#not-measured-and-why).
...
Reproduction: [`harness/README.md`](harness/README.md).
