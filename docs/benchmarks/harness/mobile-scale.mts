/**
 * Mobile shell scale measurement (`docs/specs/mobile-app.md`, R-P1 to R-P4).
 *
 ...
 * from `docs/performance-contract.md`.
 *
 * ```bash
 ...
 * See `docs/benchmarks/harness/README.md`.
 */
...
const WORDS = [
  "workspace","note","folder","editor","native","bridge","sqlite","operation","snapshot","revision",
  "journal","task","tag","person","search","index","theme","gesture","sheet","toolbar",
];
...
function documentOf(noteId: string, title: string, blocks: number, seed: number): WorkspaceDocument {
...
async function run(notes: number) {
  ...
  const bridge = countingBridge(
    createMemoryBridge({ snapshot: fixture.snapshot }),
    counter,
  );
