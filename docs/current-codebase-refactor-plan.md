...
- Auth state is managed in [src/platform/auth/index.ts](/home/remco/dev/theme-ui-clone/src/platform/auth/index.ts).
- App startup is coordinated in [src/shared/components/persistence-bootstrap.tsx](/home/remco/dev/theme-ui-clone/src/shared/components/persistence-bootstrap.tsx).
- The global provider tree mounts `AppAuthGate` and `PersistenceBootstrap` in [src/providers/app-providers.tsx](/home/remco/dev/theme-ui-clone/src/providers/app-providers.tsx).
...
- Guest seed content is created in [src/core/persistence/repositories/privacy-demo.ts](/home/remco/dev/theme-ui-clone/src/core/persistence/repositories/privacy-demo.ts).
- Local persistence is abstracted through:
  - [src/core/persistence/repositories/local-records.ts](/home/remco/dev/theme-ui-clone/src/core/persistence/repositories/local-records.ts)
...
- Remote persistence is implemented via Supabase row mappers in:
  ...
  - [src/core/persistence/supabase/records.ts](/home/remco/dev/theme-ui-clone/src/core/persistence/supabase/records.ts)
...
- [src/core/persistence/repositories/privacy-demo.ts](/home/remco/dev/theme-ui-clone/src/core/persistence/repositories/privacy-demo.ts)
...
- [src/shared/components/__tests__/persistence-bootstrap.test.tsx](/home/remco/dev/theme-ui-clone/src/shared/components/__tests__/persistence-bootstrap.test.tsx)
- [src/platform/auth/__tests__/index.test.ts](/home/remco/dev/theme-ui-clone/src/platform/auth/__tests__/index.test.ts)
- [src/core/persistence/supabase/__tests__/records.test.ts](/home/remco/dev/theme-ui-clone/src/core/persistence/supabase/__tests__/records.test.ts)
- [src/core/persistence/supabase/__tests__/sync.test.ts](/home/remco/dev/theme-ui-clone/src/core/persistence/supabase/__tests__/sync.test.ts)
- any feature-store tests affected by removing actor logic
- [ARCHITECTURE.md](/home/remco/dev/theme-ui-clone/ARCHITECTURE.md)
