...
export const SECTIONS = [
  ...
  },
  {
    ...
    searchText:
      "artificial intelligence providers models writing tools prompts default model switcher ollama gemini groq local remote playground prompt test stream usage history runs tokens token count cost spend estimate estimated retention prune clear history metadata only",
    icon: StarIcon,
    desktopOnly: true,
  },
  {
