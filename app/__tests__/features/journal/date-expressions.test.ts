...
} from "../../../src/features/journal/date-expressions";
import { dateKeyOf } from "../../../src/features/journal/dates";
...
test("date keys pad years below 1000", () => {
  const date = new Date(2000, 0, 1);
  date.setFullYear(999);
  assert.equal(dateKeyOf(date), "0999-01-01");
});
