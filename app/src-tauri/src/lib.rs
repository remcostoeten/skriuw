...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::lock::note_lock_state,
            commands::lock::configure_note_lock,
            commands::lock::unlock_note_lock,
            commands::lock::recover_note_lock,
            commands::lock::change_note_lock_secret,
            commands::lock::relock_note_lock,
            commands::lock::read_locked_documents,
            commands::lock::remove_note_lock,
