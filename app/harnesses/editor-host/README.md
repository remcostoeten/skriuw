...
Proves the standalone editor bundle (`app/src/features/editor-standalone`) against the
host protocol (`mobile/src/editor/protocol.ts`) in a browser, before any device work
