...
import { Check, Eye, EyeOff, Github, LogIn } from "lucide-react";
	...
	const runIntent = async (intent: AuthIntent, action: () => Promise<void>) => {
		try {
			...
			if (intent === "sign-in" || intent === "github") {
				void logAuthCompleted("signin", intent === "github" ? "github" : "email");
						...
						<div className="space-y-3">
							...
							<div className="relative">
								...
								>
									{isPasswordVisible ? (
										<EyeOff
											className="auth-password-toggle-icon size-4"
											aria-hidden="true"
										/>
									) : (
										<Eye
								...
								<Check
									className={cn(
										...
										rememberMe
											...
											: "opacity-0 scale-75 translate-y-px",
									)}
									strokeWidth={3}
								/>
							</span>
