...
export function Editor({ file, editorMode, onContentChange }: EditorProps) {
  ...
  if (!file) {
    return (
      <div className="flex min-h-full flex-1 items-center justify-center bg-theme-editor px-6 py-8">
  ...
  const containerClass = "flex min-h-full flex-1 flex-col overflow-y-auto bg-theme-editor";
