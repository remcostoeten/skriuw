...
import type { AiCallOptions, AiEditorHandle } from "@/features/ai/service";
...
export function Editor({ file, files = [], editorMode, onContentChange, onEditorReady, aiOptions }: EditorProps) {
