          ...
          return (
            <ContextMenu key={tab.noteId}>
              ...
              <ContextMenuContent className="w-56">
                {onDuplicateTab && (
                  <ContextMenuItem
                    onClick={() => onDuplicateTab(tab.noteId)}
                    className="text-xs"
                  >
                ...
                {onRenameNote && (
                  <ContextMenuItem
                    onClick={() => onRenameNote(tab.noteId)}
                    className="text-xs"
                  >
                ...
                {canMoveLeft && (
                  <ContextMenuItem
                    onClick={() => onMoveTabLeft(tab.noteId)}
                    className="text-xs"
                  >
                ...
                {canMoveRight && (
                  <ContextMenuItem
                    onClick={() => onMoveTabRight(tab.noteId)}
                    className="text-xs"
                  >
                ...
                {hasOtherTabs && onCloseOtherTabs && (
                  <ContextMenuItem
                    onClick={() => onCloseOtherTabs(tab.noteId)}
                    className="text-xs"
                  >
                    Close other tabs
                  </ContextMenuItem>
