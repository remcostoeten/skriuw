...
export const AI_MODELS: readonly AiModelConfig[] = [
  { id: "google.gemini-2.5-flash-lite", provider: "google", label: "Flash Lite", desc: "Fastest · cheapest" },
  { id: "google.gemini-2.5-flash", provider: "google", label: "Flash", desc: "Best balance", recommended: true },
  { id: "google.gemini-2.5-pro", provider: "google", label: "Pro", desc: "Most capable" },
  { id: "groq.llama-3.3-70b-versatile", provider: "groq", label: "Llama 3.3 70B", desc: "Groq · fast inference" },
  { id: "groq.llama-3.1-8b-instant", provider: "groq", label: "Llama 3.1 8B", desc: "Groq · ultra fast" },
