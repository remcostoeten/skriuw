    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Permanently removes all notes, folders, journal entries, and tags. Your account and AI
...
export function DataSection() {
  ...
  return (
    <>
      ...
      />
      <SettingsCard>
        <Row title="Cloud sync" description={isConnected ? "Active" : "Supabase not configured"}>
          <span
            className={
              isConnected
        ...
        <Row
          ...
          disabled
        >
          <Button variant="outline" size="sm" disabled title="Import is not yet available">
