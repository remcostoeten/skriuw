...
export function slugify(text: string): string {
  return text
    ...
    .slice(0, 100) || 'note' // Limit length and provide fallback
}

/**
 * Generates a unique slug for a note, handling duplicates
 */
export function generateNoteSlug(noteName: string, noteId: string, existingSlugs: Map<string, string>): string {
