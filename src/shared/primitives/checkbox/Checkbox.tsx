...
export const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
  function Checkbox(
    ...
    const customColorVars: React.CSSProperties = {
      ...
      ...(colors?.borderIndeterminate && { '--checkbox-border-indeterminate': colors.borderIndeterminate }),
    ...
    const ariaAttributes = {
      'aria-label': ariaLabel,
      'aria-labelledby': ariaLabelledBy || (label && `${checkboxId}-label`),
    ...
    const getStateClasses = () => {
      const stateConfig =
        state === 'indeterminate' ? styleConfig.indeterminate :
        state === 'checked' ? styleConfig.checked :
      ...
      return cn(
        ...
        isFocused && `${focusConfig.ring} ${focusConfig.ringOffset} ring-[hsl(var(--checkbox-focus-ring,var(--ring)))] ring-offset-background`,
        checkboxClassName,
    ...
    return (
      <div className={cn('flex flex-col', className)}>
        ...
        {description && (
          <p
            id={descriptionId}
            className={cn('text-muted-foreground', sizeConfig.spacing.description, sizeConfig.description)}
          >
            {description}
          </p>
        )}
