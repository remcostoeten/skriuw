...
const RichTextEditor = dynamic(
  ...
  { 
    ssr: false,
    loading: () => (
      <div className="flex-1 flex items-center justify-center bg-theme-editor">
        <div className="text-theme-dim text-sm">Loading editor...</div>
      </div>
    )
  }
);
...
export function Editor({ file, editorMode, onContentChange }: EditorProps) {
  ...
  if (!file) {
    return (
      <div className="flex-1 flex items-center justify-center bg-theme-editor">
        <p className="text-theme-dim text-sm">Select a note to start editing</p>
      </div>
    );
  }
  ...
  if (editorMode === 'richtext') {
    return (
      <div className="flex-1 overflow-hidden bg-theme-editor">
        <RichTextEditor
  ...
  // Markdown Mode
  return (
    <div className="flex-1 overflow-y-auto bg-theme-editor">
