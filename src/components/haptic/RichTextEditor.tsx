    ...
    <div className="blocknote-wrapper h-full">
      ...
      <style jsx global>{`
        .blocknote-wrapper {
          ...
          --bn-colors-menu-background: hsl(var(--theme-deep));
          --bn-colors-menu-text: var(--foreground);
          --bn-colors-tooltip-background: hsl(var(--theme-deep));
          --bn-colors-tooltip-text: var(--foreground);
          --bn-colors-hovered-background: hsl(var(--theme-hover));
          --bn-colors-selected-background: hsl(var(--theme-active));
          --bn-colors-disabled-background: hsl(var(--theme-divider));
          --bn-colors-disabled-text: hsl(var(--theme-dim));
          --bn-colors-border: hsl(var(--theme-divider));
          --bn-colors-side-menu: hsl(var(--theme-dim));
        ...
        .blocknote-wrapper .bn-inline-content code {
          background: hsl(var(--theme-hover));
