...
export function SidebarPanel({
  ...
  return (
    <div className="w-56 flex flex-col bg-theme-sidebar border-r border-theme-divider">
      {/* Toolbar icons */}
      <div className="h-11 flex items-center gap-0.5 px-3 border-b border-theme-divider">
        <button
        ...
        <button className="w-7 h-7 flex items-center justify-center rounded text-theme-dim hover:text-foreground hover:bg-theme-hover transition-colors" title="Sort">
          <Plus className="w-4 h-4" strokeWidth={1.5} />
        </button>
        <button className="w-7 h-7 flex items-center justify-center rounded text-theme-dim hover:text-foreground hover:bg-theme-hover transition-colors" title="Search">
