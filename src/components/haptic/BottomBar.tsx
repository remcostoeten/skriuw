...
export function BottomBar({ editorMode, onToggleEditorMode }: Props) {
  return (
    <div className="h-8 flex items-center justify-between px-3 bg-theme-deep border-t border-theme-divider">
      <div className="flex items-center gap-1">
        <button className="w-6 h-6 flex items-center justify-center rounded text-theme-dim hover:text-theme-secondary transition-colors">
