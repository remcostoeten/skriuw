      ...
      <div className="overflow-y-auto h-[calc(100vh-80px)] px-2">
        ...
        {searchState.query ? (
          ...
          <>
            ...
            {/* Render notes using search results */}
          ...
          // Show original drag-and-drop components when no search query
          children || (
            <div className="p-4 text-center text-muted-foreground">
