...
This is not a brochure. It is a note you can edit, fold, break, rename, link, and turn into something useful in about **ninety seconds**. The starter notes are intentionally full enough to feel like a real place.
...
The account-backed starter data now seeds with notes, folders, journal entries, and tags. The remaining risk is not correctness alone; it is whether a new user immediately understands what the editor can do.
...
> The starter notes should teach by being editable, not by explaining themselves from outside the editor.
...
How should Skriuw feel when a user moves between quick capture, structured writing, and synced cloud notes?
...
\`\`\`md
### Changed
- Replaced placeholder starter notes with richer examples.
...
<Timeline
  items={[
    ...
    { date: "Apr 10", title: "Starter notes get real folders" },
		...
		journalEntries: [
			{
				...
				dateKey: "2026-04-12",
				content: `Opened the starter notes and found the space pancake recipe.
...
The important test: the editor should feel playful before it asks me to be organized.`,
			...
			},
			{
				...
				dateKey: "2026-04-13",
				content: `Added richer starter notes with project notes, research notes, templates, and raw MDX.
...
The best onboarding is a set of notes that is useful enough to edit immediately.`,
				mood: "great",
				tags: ["mobile", "writing"],
				createdAt: iso("2026-04-12"),
				updatedAt: iso("2026-04-12"),
...
The starter notes finally have enough texture to browse instead of ignore.`,
				mood: "good",
				tags: ["experiments"],
				createdAt: iso("2026-04-13"),
				updatedAt: iso("2026-04-13"),
