/**
 * @fileoverview Create Operation Tests
 * Tests validation flow, transform order, and ID handling
 */
...
describe('create', () => {
    ...
    describe('Validation Flow', () => {
        it('should return VALIDATION_ERROR when validate returns invalid', async () => {
            ...
            const result = await create<TestEntity>('test', { name: '' }, {
        ...
        it('should proceed when validate returns valid', async () => {
            ...
            const result = await create<TestEntity>('test', { name: 'Valid' }, {
    ...
    describe('Transform Order', () => {
        ...
        it('should not call transform when validate fails', async () => {
            ...
            await create<TestEntity>('test', { name: '' }, {
        ...
        it('should pass transformed data to adapter', async () => {
            ...
            await create<TestEntity>('test', { name: 'Original' }, {
    ...
    describe('Optimistic Updates', () => {
        it('should mark result as optimistic and return entity shape immediately', async () => {
            ...
            const result = await create<TestEntity>('test', { name: 'Test' }, {
                optimistic: true,
            })
