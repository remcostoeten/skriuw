...
export const FlexRow = React.forwardRef<HTMLDivElement, Omit<FlexProps, 'direction'>>(
	({ className, ...props }, ref) => (
		<Flex ref={ref} direction='row' className={className} {...props} />
	)
)
...
export const FlexCol = React.forwardRef<HTMLDivElement, Omit<FlexProps, 'direction'>>(
	({ className, ...props }, ref) => (
		<Flex ref={ref} direction='col' className={className} {...props} />
	)
)
FlexCol.displayName = 'FlexCol'

export const FlexCenter = React.forwardRef<
	HTMLDivElement,
	Omit<FlexProps, 'preset' | 'direction' | 'justify' | 'items'>
>(({ className, ...props }, ref) => (
	<Flex ref={ref} preset='center' className={className} {...props} />
))
FlexCenter.displayName = 'FlexCenter'

export const FlexBetween = React.forwardRef<HTMLDivElement, Omit<FlexProps, 'preset' | 'justify'>>(
	({ className, ...props }, ref) => (
		<Flex ref={ref} preset='row-between' className={className} {...props} />
	)
)
