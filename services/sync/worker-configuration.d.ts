...
interface __BaseEnv_Env {
  ...
  AUTH_TRUSTED_ORIGINS:
    | "http://localhost:5183,http://tauri.localhost,tauri://localhost"
    | "https://skriuw.com,http://localhost:5183,http://tauri.localhost,tauri://localhost,https://dash.better-auth.com";
  BETTER_AUTH_URL:
    | "https://skriuw-v2-cloud-preview.remcostoeten.workers.dev"
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "AUTH_TRUSTED_ORIGINS" | "BETTER_AUTH_URL">
  > {}
}
