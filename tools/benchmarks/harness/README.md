...
[Mobile release readiness](https://docs.skriuw.com/v2/benchmarks/2026-09-20-mobile-release-readiness)
and [Mobile accessibility pass](https://docs.skriuw.com/v2/benchmarks/2026-09-20-mobile-accessibility).
...
node tools/benchmarks/harness/mobile-web-audit.mjs --dir /tmp/skriuw-mobile-web --runs 10
```
...
`apps/docs/content/v2/performance-contract.md` budgets are met on the reference Android device
...
Mobile 16 owns `apps/docs/content/v2/benchmarks` and not `mobile/`. Moving them, and wiring the
