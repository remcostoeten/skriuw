 ...
 * (`apps/docs/content/v2/specs/mobile-app.md`, R-P4) and the accessible role, name and touch
 ...
 * node tools/benchmarks/harness/mobile-web-audit.mjs --dir /tmp/skriuw-mobile-web
 * ```
 *
 ...
 * VoiceOver or TalkBack. See `tools/benchmarks/harness/README.md`.
 */
...
/** `apps/docs/content/v2/specs/mobile-app.md`, R-Q2. */
