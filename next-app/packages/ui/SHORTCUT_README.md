...
const saveAsShortcut = shortcut().combo('Ctrl', 'K').then('Ctrl', 'S').build()
...
// Sequence shortcut
const search = createSequence({ modifiers: ['Ctrl'], key: 'K' }, { modifiers: ['Ctrl'], key: 'S' })
```
...
```tsx
createSequence({ modifiers: ['Ctrl'], key: 'K' }, { modifiers: ['Ctrl'], key: 'S' })
```
