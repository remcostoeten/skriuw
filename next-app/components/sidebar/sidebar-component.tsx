...
import { IconButton, NotesIcon } from "@/shared/ui/icons";
...
export function Sidebar({ activeNoteId, contentType, customContent, ruler, openTabIds }: props) {
  ...
  }, [getSelectedCount, clearSelection, selectAll, getSelectedIds, deleteItem, getAllVisibleItemIds, filteredItems, showConfirm]);
