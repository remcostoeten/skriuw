...
export default function LeftToolbar() {
  return (
    <div className="w-12 h-full bg-haptic-darker border-r border-haptic-border flex flex-col justify-between items-center py-12 px-1.5">
      <div className="flex flex-col items-center gap-2">
        <button className="w-7 h-7 flex items-center justify-center rounded-md bg-haptic-border hover:bg-haptic-border/80 transition-colors">
          <Archive className="w-[18px] h-[18px] text-haptic-text" />
        </button>
        <button className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-haptic-border/50 transition-colors">
          <Calendar className="w-[18px] h-[18px] text-haptic-icon" />
        </button>
        <button className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-haptic-border/50 transition-colors">
          <CheckSquare className="w-[18px] h-[18px] text-haptic-icon" />
        </button>
      </div>

      <div className="flex flex-col items-center gap-2">
        <button className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-haptic-border/50 transition-colors">
          <Archive className="w-[18px] h-[18px] text-haptic-icon" />
        </button>
        <button className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-haptic-border/50 transition-colors">
          <svg className="w-4 h-4 text-haptic-icon" viewBox="0 0 16 16" fill="none">
        ...
        <button className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-haptic-border/50 transition-colors">
          <Settings className="w-[18px] h-[18px] text-haptic-icon" />
        </button>
      </div>
    </div>
  );
