...
import { createSyncLifecycle } from "@/features/sync/lifecycle";
import type { LifecyclePort } from "@/features/sync/lifecycle";
import type { MobileSyncPort, SyncRecoveryView, WorkspaceSyncStatus } from "@/features/sync/port";
import { createRecoverySurface, DISCARD_CONFIRMATION } from "@/features/sync/recovery";
import type { RecoveryView } from "@/features/sync/recovery";
import { describeSyncStatus, syncEnabled } from "@/features/sync/status";
import { createWakeChannel, isWorkspaceChanged } from "@/features/sync/wake-channel";
import type { WakeSocketHandlers } from "@/features/sync/wake-channel";
