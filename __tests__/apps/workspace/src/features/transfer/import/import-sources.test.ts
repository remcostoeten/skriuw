...
import { applyImportGrouping, planImportBundle } from "@/features/transfer/import/plan";
import { importSources } from "../../../../../../../apps/workspace/src/features/transfer/import/sources";
import { bearSource } from "@/features/transfer/import/sources/bear";
import { appleNotesSource } from "@/features/transfer/import/sources/apple-notes";
import { markdownSource } from "@/features/transfer/import/sources/markdown";
import { plainTextSource } from "@/features/transfer/import/sources/plain-text";
import { simplenoteSource } from "@/features/transfer/import/sources/simplenote";
...
test("markdown directory detects as markdown source", () => {
  ...
  const withoutObsidianSignals = detectImportSource(
    importSources,
    tree({
      files: [
  ...
  assert.equal(withoutObsidianSignals?.id, "markdown");
});
