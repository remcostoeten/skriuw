...
} from "@/features/journal/journal-template";
import { selectJournalEntries } from "@/features/journal/model";
import { noteTemplate } from "@/features/templates/note-templates";
