...
import { editorModeForNote, setEditorMode, toggleEditorMode } from "@/store/actions/editor-mode";
...
test("toggleEditorMode flips only the target note and flips back on the next call", () => {
