...
3.  Collecting critical preferences (Theme, Name, Defaults) *before* dropping them into the app.
...
-   *Edge Case*: Handle upload failure gracefully. Allow "Skip for now".

**Step 3: Aesthetics (Theme)**
-   Show 3 cards: Light, Dark, System.
-   *Instant Preview*: Clicking a card should immediately toggle the app's Tailwind theme class to preview.

**Step 4: Defaults (The "Skriuw" Touch)**
-   Set `noteCreationMode` (Simple vs Rich) - *links to Settings*.
-   Set `defaultEmoji`.
