...
This page is the map; the detail pages are [Self-host with Docker](/infra/self-host-docker)
and [Release pipeline](/infra/release-pipeline).
...
- **Self-host (Docker)**, you want a server/homelab instance you own, usable
  ...
  [Self-host with Docker](/infra/self-host-docker).
