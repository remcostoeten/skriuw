...
export function JournalCalendarFeedManager() {
		...
		<div className="space-y-3">
			...
			{httpsUrl && (
				<div className="space-y-2 rounded-md border border-border bg-muted/40 p-3">
					...
					<p className="text-[11px] text-amber-600 dark:text-amber-500">
						This secret is shown once. Anyone with it can read your journal calendar.
					</p>
						...
						<div className="space-y-2">
							...
							<div className="flex gap-2">
								...
								>
									...
									{target === "google" ? "Open Google Calendar" : "Open Outlook"}
								</a>
							</div>
						</div>
					)}
			...
			<div className="space-y-2">
				{busy && activeTokens.length === 0 ? (
					...
					<p className="text-xs text-muted-foreground">No active subscription links.</p>
				) : (
