 ...
 *
 * Memoized: rows re-render on every FileList state change, and this subtree
 * carries the full AnimatePresence stack per row. Motion features come from the
 * workspace shell's LazyMotion, so no per-row provider is mounted here.
 */
export const NoteNameLabel = memo(function NoteNameLabel({ name, className }: TProps) {
