...
function TemplatePickerDialog({ onClose, onPick }: DialogProps) {
  ...
  return (
    ...
    >
      <div
        className="mt-[16vh] flex h-fit max-h-[56vh] w-[calc(100vw-1.5rem)] max-w-md flex-col overflow-hidden rounded-xl border border-border bg-popover text-popover-foreground shadow-2xl shadow-black/40"
        role="dialog"
        aria-modal="true"
