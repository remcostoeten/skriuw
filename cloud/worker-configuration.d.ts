/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8d1805c2ea9023d57ec8cd08771dfbba)
// Runtime types generated with workerd@1.20260730.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	SYNC_CONTENT: R2Bucket;
	AUTH_DB: D1Database;
	AUTH_TRUSTED_ORIGINS: "http://localhost:5183,http://tauri.localhost,tauri://localhost" | "https://skriuw.com,http://localhost:5183,http://tauri.localhost,tauri://localhost,https://dash.better-auth.com";
	BETTER_AUTH_URL: "https://skriuw-v2-cloud-preview.remcostoeten.workers.dev" | "https://skriuw-v2-cloud.remcostoeten.workers.dev";
	WORKSPACES: DurableObjectNamespace<import("./src/index").WorkspaceSyncObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WorkspaceSyncObject";
	}
	interface PreviewEnv {
		SYNC_CONTENT: R2Bucket;
		AUTH_DB: D1Database;
		AUTH_TRUSTED_ORIGINS: "http://localhost:5183,http://tauri.localhost,tauri://localhost";
		BETTER_AUTH_URL: "https://skriuw-v2-cloud-preview.remcostoeten.workers.dev";
		WORKSPACES: DurableObjectNamespace<import("./src/index").WorkspaceSyncObject>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_TRUSTED_ORIGINS" | "BETTER_AUTH_URL">> {}
}
