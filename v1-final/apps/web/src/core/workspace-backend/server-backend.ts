...
export const serverBackend: WorkspaceBackend = {
	...
	listCoverImages: listNoteCoverImages,
	listCoverImagesDetailed: listNoteCoverImagesDetailed,
	deleteCoverImage: deleteNoteCoverImage,
